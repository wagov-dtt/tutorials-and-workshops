---
title: "ArgoCD"
description: "GitOps with ArgoCD on EKS."
weight: 80
icon: "sync"
---
...
- [LEARNING_PATH.md](../learning-path.md#31-argocd) - Step-by-step walkthrough
- [GLOSSARY.md](../glossary.md#gitops) - GitOps definition
- [eksauto/](eksauto.md) - Terraform that creates the ArgoCD capability
