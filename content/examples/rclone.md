---
title: "rclone CSI"
description: "Local S3-compatible filesystem mount using rclone CSI."
weight: 20
icon: "folder-open"
---
...
- [LEARNING_PATH.md](../learning-path.md#13-csi-volumes-with-rclone) - Step-by-step walkthrough
- [GLOSSARY.md](../glossary.md) - Definitions (CSI, rclone)
- [s3-pod-identity/](s3-pod-identity.md) - CSI mounts with real AWS S3 and Pod Identity
