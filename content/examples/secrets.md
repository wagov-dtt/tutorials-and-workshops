...
description: "External Secrets Operator with AWS Secrets Manager."
weight: 70
icon: "key"
---
...
- [LEARNING_PATH.md](../learning-path.md#23-external-secrets) - Step-by-step walkthrough
- [GLOSSARY.md](../glossary.md) - Definitions (Secrets Manager, Pod Identity)
- [eksauto/](eksauto.md) - Terraform that creates the IAM role and secret
