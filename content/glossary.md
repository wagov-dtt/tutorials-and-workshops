---
title: "Glossary"
description: "Definitions for Kubernetes, AWS, and DevOps terms used in this repo."
weight: 30
icon: "book-open"
---
...
**Used in**: [rclone/](examples/rclone.md), [s3-pod-identity/](examples/s3-pod-identity.md)
...
**Used in**: [kustomize/](examples/kustomize.md), all example directories
...
**Used in**: [eksauto/](examples/eksauto.md), [s3-pod-identity/](examples/s3-pod-identity.md), [secrets/](examples/secrets.md)
...
**Used in**: [eksauto/](examples/eksauto.md)
...
**Used in**: [s3-pod-identity/](examples/s3-pod-identity.md), [secrets/](examples/secrets.md)
...
**Used in**: [secrets/](examples/secrets.md)
...
**Used in**: [argocd/](examples/argocd.md)
