...
description: "First-time setup, first local cluster, and beginner troubleshooting."
weight: 10
icon: "rocket"
---
...
**Cost warning**: EKS clusters cost money—see [eksauto/](examples/eksauto.md) for details. Always run `just destroy-eks` when done!

Once you've completed this guide, use [DevSecOps Induction](_index.md) for the broader study map, then continue with [LEARNING_PATH.md](learning-path.md) for detailed walkthroughs of each example.
